 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://server.example.org/", wsdlLocation = "http://localhost:8081/ws/user?wsdl")
    ...
    extends Service
{
    ...
    private static final QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://server.example.org/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/ws/user?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://server.example.org/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.example.org/", "UserServiceImplPort"), UserService.class, features);
    }
